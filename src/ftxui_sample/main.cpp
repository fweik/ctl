...
// configuration step. It creates a namespace called `ctl`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", ctl::cmake::project_name, ctl::cmake::project_version) };
